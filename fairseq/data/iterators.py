...
class EpochBatchIterator(EpochBatchIterating):
    ...
    def __init__(
        ...
        if args is not None and hasattr(args,'dataset'):
            disable_prefetch = getattr(args.dataset,'disable_prefetch',False)
            self._supports_prefetch = False if disable_prefetch else True
        else:
    ...
    def first_batch(self):
        ...
        if getattr(self.dataset, "supports_fetch_outside_dataloader", True) and self._supports_prefetch:
