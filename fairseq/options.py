...
def add_preprocess_args(parser):
    ...
    group.add_argument('--xlmr-task', default='encft', type=str,
                       choices=['vanilla','encft', 'encnoft','embft','embnoft','encnoft_merge','encnoft_emb','mbart_ft','mbart_ft_all'],
                       help='perform task related to xlmr')
    group.add_argument('--mplm-type', default='xlmr', type=str,
                       choices=['xlmr','xlm','infoxlm'], help='type of multilingual pretrained model')   
    group.add_argument("--only-alignment", action="store_true",
                       help="Only process the alignment files")                
    # fmt: on
    return parser
