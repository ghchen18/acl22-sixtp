...
class BARTModel(TransformerModel):
    ...
    def __init__(self, args, encoder, decoder):
        ...
        if hasattr(args, 'lang_dict'):
            with open(args.lang_dict, 'r') as fin:
                self.langs = [lang.strip() for lang in fin.readlines() if lang.strip()]
        else:
    ...
    def forward(
        ...
        **extra_args,
        ...
        if tgt_lang_id is not None and hasattr(tgt_lang_id, 'size'):
